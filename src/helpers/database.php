...
class Database extends PDO
{
    ...
    {
        try {
            parent::__construct(Conf::DB_TYPE . ':host=' . Conf::DB_HOST . ';dbname=' . Conf::DB_NAME . ';charset=utf8', Conf::DB_USER, Conf::DB_PASS);
    ...
    {
        return Database::ITEMS_PER_PAGE * ($page - 1);
    }
}
